...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Para móviles, mostrar banner después de un tiempo
    if (isMobile) {
        setTimeout(() => {
            if (!checkIfInstalled()) {
                console.log('📱 Mostrando banner de instalación en móvil');
                showInstallBanner();
            }
        }, 3000);
    }
...
// Crear banner de instalación para móviles
function createInstallBanner() {
    ...
    installBanner.innerHTML = `
        ...
        " id="banner-content">
            ...
            <div style="display: flex; gap: 10px; align-items: center;">
                <button onclick="window.pwaInstallBanner.install()" style="
                    background: rgba(255,255,255,0.2);
                ...
                <button onclick="window.pwaInstallBanner.close()" style="
                    background: none;
                    border: none;
                    color: white;
                    padding: 8px;
                    ...
                    align-items: center;
                    justify-content: center;
                " onmouseover="this.style.opacity='1'; this.style.background='rgba(255,255,255,0.2)'" onmouseout="this.style.opacity='0.8'; this.style.background='none'">
    ...
    bannerStyle.textContent = `
        ...
        .banner-slide-out {
            animation: slideOutBanner 0.3s ease-in forwards !important;
        }
        
        /* Ajustar contenido cuando banner está visible */
        body.banner-visible {
...
function showInstallBanner() {
    ...
    if (installBanner) {
        ...
        // Mostrar también el botón flotante después de que se oculte el banner
        setTimeout(() => {
            if (!checkIfInstalled()) {
                showInstallButton();
            }
...
function hideInstallBanner() {
    if (installBanner) {
        ...
        console.log('🙈 Banner de instalación ocultado');
    }
}
...
function setupInstallPrompt() {
    window.addEventListener('beforeinstallprompt', (e) => {
        ...
        // En móviles, mostrar banner; en desktop, mostrar botón
        if (isMobile) {
...
// Funciones específicas del banner
